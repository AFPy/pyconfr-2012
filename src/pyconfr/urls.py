...
from pyconfr.views import creole_preview
...
urlpatterns = patterns("",
    ...
    url(r"^about/coc$", direct_to_template, {"template": "pycon/coc.html"},
                                         name="coc"),
    url(r"^sprints/$", direct_to_template, {"template": "pycon/sprints.html"}, name="sprints"),
    url(r"^sponsors/prospectus/$", direct_to_template,
        {"template": "sponsors/prospectus.html"}, name="prospectus"),
    url(r"^registration/$", direct_to_template, {"template": "pycon/registration.html"}, name="registration"),
    url(r"^test/$", direct_to_template, {"template": "pycon/test.html"}, name="test"),
    # url(r"^registration/$", direct_to_template, {"template": "pycon/registration.html"}, name="registration"),
...
if settings.SERVE_MEDIA:
    urlpatterns += patterns("",
        ...
        url(r"^%s/media/(?P<path>.*)$" % settings.PYCON_YEAR, "django.views.static.serve", {
